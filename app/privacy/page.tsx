...
export default function PrivacyPage() {
  ...
  const sections = [
    { ar: { title: 'مقدمة', body: 'توضح سياسة الخصوصية هذه كيف تجمع شركة الشمس كلين وتستخدم وتحمي بياناتك الشخصية عند استخدامك لموقعنا الإلكتروني أو خدماتنا.' }, en: { title: 'Introduction', body: 'This privacy policy explains how Shams Clean Company collects, uses, and protects your personal data when you use our website or services.' } },
